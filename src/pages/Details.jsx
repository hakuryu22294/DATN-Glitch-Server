...
const Details = () => {
  ...
  return (
    <div>
      ...
      <section>
        <div className="bg-rose-100 py-5 mb-5">
          <div className="w-[85%]  md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
      ...
      <section>
        <div className="w-[85%] shadow-sm md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto pb-16">
          <div className="grid grid-cols-2 md-lg:grid-cols-1 gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-slate-600">
                ...
                <Link
                  to={`/shop/${seller?._id}`}
                  className="text-slate-600 py-1 font-bold"
                >
                  Shop Name : {seller?.shopInfo?.shopName}
                </Link>
              </div>
              ...
              <div className="pl-4 md-lg:pl-0">
                ...
                <div className="flex flex-col gap-5 mt-3 border p-3">
                  {moreProducts?.map((p, i) => {
                    return (
                      <Link key={i} to={`/details/${p.slug}`} className="block">
