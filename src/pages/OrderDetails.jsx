...
import { get_order_details } from "../redux/store/reducers/orderReducer";
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p>
            ...
            <span className="text-slate-600 text-sm">
              ...
              {order?.shippingInfo?.province.full_name}
        ...
        <div className="text-slate-600">
          <h2 className="font-mono">
            Price : {formatCurrency(order?.totalPrice)} Include Shipping
          </h2>
