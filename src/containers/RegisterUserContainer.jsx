...
import { validationRegisterUser } from '../config/yup/validateForm';

const RegisterUserContainer = ({setUiForm}) => {
        ...
        <>
            <form method='POST' onSubmit={formik.handleSubmit}>
                <div>
                    ...
                    <span className='block text-[15px]'>Đăng ký tài khoản khách hàng</span>
                    <input
                        type="text"
                        name="name"
                    ...
                    {formik.touched.phoneNumber && formik.errors.phoneNumber ? (
                        <div className="text-rose-500">{formik.errors.phoneNumber}</div>
                    ) : null}

               
                     <select name="" id="" className='border-2 w-full p-2 rounded-[5px]'>
                    ...
                    <div>
                        <span className='text-rose-600 block pt-2 cursor-pointer' onClick={()=>setUiForm(1)}>Đăng ký với tư cách <b>shop</b></span>
                    </div>
                </div>
            </form>
        </>
