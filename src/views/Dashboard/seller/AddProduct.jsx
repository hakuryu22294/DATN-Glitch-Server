    ...
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4 bg-gray-100 rounded-md shadow-md">
        <div className="flex justify-between items-center pb-4">
          <h1 className="text-gray-800 text-xl font-semibold">Add Product</h1>
          <Link
        ...
        <div className="grid grid-cols-8 xs:grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 gap-3 w-full text-gray-800 mb-4">
          {imageShow.map((img, i) => (
        ...
        <div>
          <form onSubmit={add}>
            <div className="flex flex-col mb-3 md:flex-row gap-4 w-full text-gray-800">
              <div className="flex flex-col w-full gap-1">
                <label htmlFor="name">Product Name</label>
                <input
                  className="px-4 py-2 focus:border-blue-500 outline-none bg-gray-200 border border-gray-300 rounded-md text-gray-800"
