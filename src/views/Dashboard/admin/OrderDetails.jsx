...
const OrderDetails = () => {
  ...
  useEffect(() => {
    setStatus(shopOrder?.deliveryStatus);
  }, [shopOrder]);
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4shadow-md rounded-md">
              ...
              <div className="pr-3 text-[#d0d2d6] text-lg">
                <div className="flex flex-col gap-1">
                  <h2 className="pb-2 font-semibold">
                    Deliver To : {shopOrder.shippingInfo?.name}{" "}
                  </h2>
                  <p>
                    <span className="text-sm">
                      {shopOrder.shippingInfo?.address}
                      {shopOrder.shippingInfo?.province}
                      {shopOrder.shippingInfo?.city}
                      {shopOrder.shippingInfo?.area}
                    </span>
                  </p>
                </div>
                <div className="flex justify-start items-center gap-3">
                  <h2>Payment Status: </h2>
                  <span className="text-base">{shopOrder.payment_status}</span>
                </div>
                <span>Price : ${shopOrder.price}</span>
